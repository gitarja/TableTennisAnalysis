...
shap.summary_plot(shap_values_all, X_test_all, plot_type="bar", max_display=len(x_double_features_column), show=False)

# plt.show()

plt.savefig(results_path + "images\\bar.png", format='png')
plt.close()


plotSHAP(shap_values_all,X_test_all, x_double_features_column, results_path + "images\\")
